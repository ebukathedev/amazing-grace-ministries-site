...
const events: ChurchEvent[] = [
  {
    ...
    description: 'An evening of worship, connection, and community. Come meet new friends and deepen existing relationships.',
    isHighlighted: false,
  ...
  },
  {
    ...
    description: 'A full day experience for students to encounter God, build friendships, and discover their purpose.',
    isHighlighted: false,
  ...
  },
  {
    ...
    time: '10:00 AM',
    location: 'Sanctuary',
    description: 'Our weekly family gathering — Spirit-filled worship, powerful teaching, and real community.',
    isHighlighted: false,
  ...
  },
  {
    ...
    time: '6:00 PM Friday',
    location: 'Main Sanctuary',
    description: 'A dedicated weekend of corporate prayer, fasting, and seeking God together as a church family.',
    isHighlighted: false,
  ...
  },
  {
    ...
    description: 'Join us as we serve our city. Food distribution, community cleanup, and free family activities.',
    isHighlighted: false,
  ...
  },
  {
    ...
    time: '9:00 AM',
    location: 'Fellowship Hall',
    description: 'A day of empowerment, worship, and sisterhood. Speakers, workshops, and meaningful connection.',
    isHighlighted: false,
