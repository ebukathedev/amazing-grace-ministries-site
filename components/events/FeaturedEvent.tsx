...
export default function FeaturedEvent() {
  return (
    ...
    >
      ...
      <div
        className="
          max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-0 rounded-2xl overflow-hidden border shadow-ph-deeper reveal
      ...
      >
        ...
        <div
          className="
            flex flex-row lg:flex-col items-center justify-center p-6 lg:p-10 bg-gold lg:col-span-1 gap-2 lg:gap-0
          "
        >
        ...
        <div
          className="
            lg:col-span-4 p-8 lg:p-10 flex flex-col justify-center transition-colors duration-300
        ...
        >
          ...
          <h2
            className="
              font-display font-bold text-[38px] lg:text-[42px] leading-tight
          ...
          <p
            className="
              font-body text-[16px] leading-relaxed mt-4 max-w-xl
              text-light-secondary dark:text-white/60
            "
          >
            An evening of worship, connection, and community. Come meet new friends, deepen existing relationships, and experience the warmth of the Amazing Grace family. No registration required &mdash; just show up.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-8">
            <a
              href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Amazing+Grace+Ministries+Community+Night&dates=20250615T180000/20250615T200000&details=An+evening+of+worship,+connection,+and+community.+Come+meet+new+friends+and+deepen+existing+relationships.&location=715+Edgerton+Street,+Saint+Paul,+MN+55130"
              target="_blank"
              rel="noopener noreferrer"
              className="
                bg-gold text-dark-charcoal font-body font-bold text-[13px] uppercase tracking-[0.08em] px-7 py-3.5 rounded-sm
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="
                font-body font-semibold text-[13px] uppercase tracking-[0.08em] px-7 py-3.5 rounded-sm transition-all flex items-center justify-center gap-2
